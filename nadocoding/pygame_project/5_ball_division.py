...
while running :
    ...
    #     weapons = [weapon_x_pos, weapon_y_pos - (weapon_speed * dt)]
    # 병신 ㅋㅋ 이거는 위에거랑 다르잖아. 위는... 쨋든 다름 ㅋㅋ

    ## 공 위치 정의
    for ball_idx, ball_val in enumerate(balls) : ## 연습은 enumerate_practice 안에 함
        ...
        for weapon_idx, weapon_val in enumerate(weapons) :
            ...
            if weapon_rect.colliderect(ball_rect) :
                ...
                if ball_img_idx < 3:
                    ...
                    # 오른쪽
                    balls.append({
                        "pos_x" : ball_pos_x + (ball_width / 2), # 공 x좌표
                        "pos_y" : ball_pos_y + (ball_height / 2) - (small_ball_height / 2), # 공 y좌표
                        "img_idx" : ball_img_idx + 1, # 공 이미지 인덱스
                        "to_x" : 3, # x축 이동방향, -3 왼 , 3 오른
                        "to_y" : -6, # y축 이동방향
